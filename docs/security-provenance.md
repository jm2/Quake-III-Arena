...
| Oversized/truncated PK3 entries | Local audit; [#36](https://github.com/jm2/Quake-III-Arena/issues/36) | ZIP-controlled unsigned size narrowed to `int`; unzip opens/reads and public pointer/state transitions were unchecked | Locally validates ZIP sizes, ownership, metadata, seeks and public API transactions with real malformed fixtures; central-directory discovery/open arithmetic and retail acceptance remain |
