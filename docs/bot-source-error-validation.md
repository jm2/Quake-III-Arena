...
A private source diagnostic generation distinguishes newly failed lookahead
from recoverable historical errors. Explicit script reset clears parse status
while preserving formatting flags. Commercial 1.32c public imports/QVM/syscalls,
protocol and asset layouts remain unchanged; the private native source receives
one generation field. Existing valid nested includes and native EOF retain their behavior.
...
comment. Original native one/two-level include goldens also pass. Two review-stage
actual-body proofs expose rejected EOF strings after recoverable errors and
failed explicit script resets. Fixed tests also reject a new lookahead error
when earlier history already exists.
...
| --- | ---: | --- |
| Quake3 | 3,766,589 | `ed8c9d3b3577543b25cc7a06319bfd905e5b2f427fb45f66a44893f2e359a142` |
| Quake3_TeamArena | 3,919,259 | `6ccd9a6217181ff215c6af952d85b1b44a05ae56f92017c837508b58ed9984ee` |
