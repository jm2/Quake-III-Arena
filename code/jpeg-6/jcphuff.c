...
typedef struct {
  ...
  unsigned long put_buffer;		/* current bit-accumulation buffer */
...
/* Emit some bits, unless we are in gather mode */
{
  ...
  register unsigned long put_buffer = (unsigned long) code;
  ...
  put_buffer &= (1UL<<size) - 1; /* mask off any extra bits in code */
