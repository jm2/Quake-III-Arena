...
{
	signed char offset;		//-1 = unset; explicitly signed so it survives unsigned-char targets
	int length;
} bot_matchvariable_t;
...
//replace all the context related synonyms in the string within size bytes
