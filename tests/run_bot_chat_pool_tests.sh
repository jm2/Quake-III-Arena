...
Q3_TEST_BINARY="$(mktemp "${TMPDIR:-/var/tmp}/q3-bot-chat-pool.XXXXXX")"
...
for Q3_TEST_MODE in normal fast debug debug-fast manager manager-fast;do
    ...
    "${CC:-cc}" -DBOTLIB -std=gnu99 -fgnu89-inline -fno-omit-frame-pointer -ffunction-sections -fdata-sections \
        ...
        "$Q3_TEST_ROOT/tests/bot_chat_pool_regression.c" "$Q3_TEST_ROOT/code/botlib/l_libvar.c" "$Q3_TEST_ROOT/code/botlib/l_memory.c" "$Q3_TEST_ROOT/code/botlib/l_precomp.c" "$Q3_TEST_ROOT/code/botlib/l_script.c" "$Q3_TEST_ROOT/code/botlib/l_struct.c" "$Q3_TEST_ROOT/code/game/q_shared.c" \
