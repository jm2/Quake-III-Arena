...
Q3_TEST_BINARY="$(mktemp "${TMPDIR:-/var/tmp}/q3-bot-move-setup.XXXXXX")"
...
for Q3_TEST_MODE in normal fast;do
    ...
    "${CC:-cc}" -std=gnu99 -fgnu89-inline -fno-omit-frame-pointer -ffunction-sections -fdata-sections \
        ...
        "-DQ3_MOVE_SOURCE=\"$Q3_TEST_ROOT/code/botlib/be_ai_move.c\"" \
        "$Q3_TEST_ROOT/tests/bot_move_setup_regression.c" "$Q3_TEST_ROOT/code/botlib/l_libvar.c" "$Q3_TEST_ROOT/code/game/q_shared.c" \
