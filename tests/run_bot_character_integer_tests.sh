...
Q3_TEST_BINARY="$(mktemp "${TMPDIR:-/var/tmp}/q3-bot-character-integer.XXXXXX")"
...
for Q3_TEST_MODE in normal fast;do
    ...
    "${CC:-cc}" -DBOTLIB -std=gnu99 -fgnu89-inline -fno-omit-frame-pointer -ffunction-sections -fdata-sections \
        ...
        "-DQ3_INTEGER_NATIVE=\"$Q3_TEST_ROOT/tests/bot_character_integer_native.h\"" \
        "$Q3_TEST_ROOT/tests/bot_character_integer_regression.c" "$Q3_TEST_ROOT/code/botlib/l_precomp.c" \
