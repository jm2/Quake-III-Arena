...
Q3_TEST_BINARY="$(mktemp "${TMPDIR:-/var/tmp}/q3-aas-routing-work.XXXXXX")"
...
for Q3_TEST_MODE in normal fast; do
    ...
    "${CC:-cc}" -std=gnu99 -fgnu89-inline -fno-omit-frame-pointer -ffunction-sections -fdata-sections \
        ...
        "$Q3_TEST_ROOT/tests/aas_routing_workspace_regression.c" -Wl,--gc-sections -lm -o "$Q3_TEST_BINARY"
