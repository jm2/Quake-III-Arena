...
int main(void) {
	...
	/* Direct binary32 conversion must distinguish values above an exact midpoint. */
	Build("{ \"gridsize\" \"1.0000000596046447753906250000000000000000000001\" }",strlen("{ \"gridsize\" \"1.0000000596046447753906250000000000000000000001\" }"),10);Bounds(0,10);Load();Check(s_worldData.lightGridData && s_worldData.lightGridSize[0]==0x1.000002p+0f && s_worldData.lightGridBounds[0]==10,"above-midpoint decimal keeps q3map's direct float value and ten samples");Sample(10,0,0,9);
	Build("{ \"gridsize\" \"1.000000059604644775390625\" }",strlen("{ \"gridsize\" \"1.000000059604644775390625\" }"),11);Bounds(0,10);Load();Check(s_worldData.lightGridData && s_worldData.lightGridSize[0]==1.0f && s_worldData.lightGridBounds[0]==11,"exact decimal midpoint rounds to even and keeps eleven samples");Sample(10,0,0,10);
